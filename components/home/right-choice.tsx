      ...
      <div className="lg:grid lg:grid-cols-2 lg:min-h-[600px]">
        ...
        >
          <div className="absolute inset-0">
            ...
            />
            {/* Gradient overlay */}
            <div className="absolute inset-0 bg-gradient-to-r from-emerald-900/60 via-emerald-800/40 to-transparent" />
          </div>
        ...
        {/* Content Section */}
        <motion.div
          className="relative bg-gradient-to-br from-emerald-600 via-green-600 to-teal-600 px-8 py-16 lg:px-16 lg:py-20 text-white flex items-center justify-center overflow-hidden"
          initial={{ opacity: 0, x: 50 }}
          animate={isInView ? { opacity: 1, x: 0 } : {}}
          transition={{ duration: 0.8, ease: "easeOut" }}
        >
          ...
          <div className="absolute inset-0">
            ...
            <div className="absolute bottom-10 left-10 w-72 h-72 bg-teal-400/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: "1s" }} />
          </div>

          {/* Decorative pattern */}
          <div className="absolute top-0 right-0 w-1/2 h-full opacity-10">
            <div className="grid grid-cols-6 gap-4 rotate-12 transform translate-x-1/4">
              {[...Array(48)].map((_, i) => (
                <motion.div
                  key={i}
          ...
          <div className="relative z-10 max-w-lg">
            ...
            >
              ...
              <span className="text-teal-100">Future?</span>
            </motion.h2>
            ...
            <Link href="/courses">
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="group relative w-full sm:w-auto px-8 py-4 bg-white text-emerald-700 font-bold text-lg rounded-xl overflow-hidden shadow-2xl"
              >
            ...
            <motion.p
              ...
              className="mt-6 text-sm text-emerald-100 flex items-center gap-2"
            >
